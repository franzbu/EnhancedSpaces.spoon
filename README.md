...
EnhancedSpaces' features include using [sticky windows](https://github.com/franzbu/EnhancedSpaces.spoon/tree/main#same-window-on-more-than-one-mspace), [swapping windows](https://github.com/franzbu/EnhancedSpaces.spoon/blob/main/README.md#swapping-windows), [showing all mSpaces](https://github.com/franzbu/EnhancedSpaces.spoon/blob/main/README.md#mspace-control) on a grid while you can cycle through them, [opening windows](https://github.com/franzbu/EnhancedSpaces.spoon/tree/main#open-windows-in-pre-arranged-mspaces) automatically on predefined mSpaces in predefined sizes and positions, and [mSpace Control](https://github.com/franzbu/EnhancedSpaces.spoon/blob/main/README.md#experimental-features), where you can see all your mSpaces on a grid and can directly activate and switch to individual windows. Using EnhancedSpaces' window manager you can resize and rearrange your windows with keyboard shortcuts or with your mouse or trackpad. Additionally, the most common features are available via [menu](https://github.com/franzbu/EnhancedSpaces.spoon/blob/main/README.md#menu) and [popup menu](https://github.com/franzbu/EnhancedSpaces.spoon/tree/main#popup-menus).

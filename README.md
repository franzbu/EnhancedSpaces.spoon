...
Mellon helps you manage windows and spaces. Due to limitations of Apple's Spaces, Mellon incorporates an improved version of Spaces; they will be referred to as mSpaces.
...
```lua
  ...
  modifierMoveWinMSpace = { 'alt', 'shift' }, -- default: { 'alt', 'shift' }
  ...
```

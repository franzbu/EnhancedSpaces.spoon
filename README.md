...
I dismissed my multi-monitor arrangement in favor of virtual screens years ago and have never looked back. I started out using macOS' built-in Spaces and used add-ons that added improvements to Apple's rather simplistic approach. However, Apple haven't seemed to care to be looking out for any developers of add-ons for Spaces, and recent changes to macOS made the use of any of the add-ons that provided deeper integration such as moving windows to other Spaces impossible.

...
Focus has also been given to making EnhancedSpaces pleasing to use, for example, you can set different wallpapers for the different mSpaces and customize the EnhancedSpaces' menus.

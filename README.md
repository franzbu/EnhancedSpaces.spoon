...
This animated GIF doesn't show what EnhancedSpaces is mainly about, which is organizing windows on more than one virtual screen (called mSpace in EnhancedSpaces), as that is better experienced first-hand. 
